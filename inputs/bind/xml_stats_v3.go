...
// addStatsXMLv3 walks a v3Stats struct and adds the values to the sample list
func (b *Instance) addStatsXMLv3(stats v3Stats, slist *types.SampleList, hostPort string) {
	...
	slist.PushSamples("bind_memory", fields, map[string]string{"url": hostPort, "source": host, "port": port})
...
func (b *Instance) readStatsXMLv3(addr *url.URL, slist *types.SampleList) error {
	var stats v3Stats
	...
	b.addStatsXMLv3(stats, slist, addr.Host)
	return nil
}
