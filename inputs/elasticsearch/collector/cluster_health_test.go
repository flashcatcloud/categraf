	...
	tests := []struct {
	...
	}{
		{
			...
			want: `
        		...
        		elasticsearch_cluster_health_active_shards_percent{cluster="elasticsearch"} 0
...
func TestClusterHealthIndices(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			file: "../fixtures/clusterhealth/1.7.6.json",
			want: `
				# HELP elasticsearch_cluster_health_indices_active_primary_shards The number of primary shards in your cluster. This is an aggregate total across all indices.
				# TYPE elasticsearch_cluster_health_indices_active_primary_shards gauge
				elasticsearch_cluster_health_indices_active_primary_shards{cluster="elasticsearch"} 5
				# HELP elasticsearch_cluster_health_indices_active_shards Aggregate total of all shards across all indices, which includes replica shards.
				# TYPE elasticsearch_cluster_health_indices_active_shards gauge
				elasticsearch_cluster_health_indices_active_shards{cluster="elasticsearch"} 5
				# HELP elasticsearch_cluster_health_indices_initializing_shards Count of shards that are being freshly created.
        		# TYPE elasticsearch_cluster_health_indices_initializing_shards gauge
				elasticsearch_cluster_health_indices_initializing_shards{cluster="elasticsearch"} 0
				# HELP elasticsearch_cluster_health_indices_number_of_replicas Number of replicas in the cluster.
        		# TYPE elasticsearch_cluster_health_indices_number_of_replicas gauge
        		elasticsearch_cluster_health_indices_number_of_replicas{cluster="elasticsearch"} 0
        		# HELP elasticsearch_cluster_health_indices_number_of_shards Number of shards in the cluster.
        		# TYPE elasticsearch_cluster_health_indices_number_of_shards gauge
        		elasticsearch_cluster_health_indices_number_of_shards{cluster="elasticsearch"} 0
				# HELP elasticsearch_cluster_health_indices_relocating_shards The number of shards that are currently moving from one node to another node.
				# TYPE elasticsearch_cluster_health_indices_relocating_shards gauge
				elasticsearch_cluster_health_indices_relocating_shards{cluster="elasticsearch"} 0
				# HELP elasticsearch_cluster_health_indices_status Whether all primary and replica shards are allocated.
				# TYPE elasticsearch_cluster_health_indices_status gauge
				elasticsearch_cluster_health_indices_status{cluster="elasticsearch",color="green"} 0
				elasticsearch_cluster_health_indices_status{cluster="elasticsearch",color="red"} 0
				elasticsearch_cluster_health_indices_status{cluster="elasticsearch",color="yellow"} 1
				# HELP elasticsearch_cluster_health_indices_unassigned_shards The number of shards that exist in the cluster state, but cannot be found in the cluster itself.
				# TYPE elasticsearch_cluster_health_indices_unassigned_shards gauge
				elasticsearch_cluster_health_indices_unassigned_shards{cluster="elasticsearch"} 5
      `,
		},
		{
			name: "2.4.5",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			c := NewClusterHealthIndices(http.DefaultClient, u)
			if err != nil {
				t.Fatal(err)
			}
