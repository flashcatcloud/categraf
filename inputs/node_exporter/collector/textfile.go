...
var (
	textFileDirectory = new(string)
	// kingpin.Flag("collector.textfile.directory", "Directory to read text files with metrics from.").Default("").String()
...
func textFileCollectorInit(params map[string]string) {
	*textFileDirectory = params["collector.textfile.directory"]
}
