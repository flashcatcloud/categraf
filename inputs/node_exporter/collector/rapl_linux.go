...
var (
	raplZoneLabel = new(bool) // kingpin.Flag("collector.rapl.enable-zone-label", "Enables service unit metric unit_start_time_seconds").Bool()
)
...
func raplCollectorInit(params map[string]string) {
	*raplZoneLabel = params["collector.rapl.enable-zone-label"] == "true"
}
