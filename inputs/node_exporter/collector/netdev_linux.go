...
var (
	netDevNetlink = new(bool)
	// kingpin.Flag("collector.netdev.netlink", "Use netlink to gather stats instead of /proc/net/dev.").Default("true").Bool()
)
...
func netDevLinkInit(params map[string]string) {
