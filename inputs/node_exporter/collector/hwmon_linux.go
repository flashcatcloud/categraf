...
var (
	collectorHWmonChipInclude = new(string) // kingpin.Flag("collector.hwmon.chip-include", "Regexp of hwmon chip to include (mutually exclusive to device-exclude).").String()
	collectorHWmonChipExclude = new(string) // kingpin.Flag("collector.hwmon.chip-exclude", "Regexp of hwmon chip to exclude (mutually exclusive to device-include).").String()
...
func hwMonCollectorInit(params map[string]string) {
	*collectorHWmonChipInclude = params["collector.hwmon.chip-include"]
	*collectorHWmonChipExclude = params["collector.hwmon.chip-exclude"]
}
