...
不同 namespace 附加 label 所需权限点：
 ...
 - polardb: `polardb:DescribeDBClusters` `acs:polardb:*:*:dbcluster/*` [链接](https://help.aliyun.com/document_detail/118034.html?spm=a2c4g.98094.0.0)
 - kvstore: `kvstore:DescribeInstances` `acs:kvstore:$regionid:$accountid:instance/$instanceid` [链接](https://help.aliyun.com/apsara/enterprise/v_3_18_0/kvstore/enterprise-developer-guide/api-authentication-rules.html)
 - ecs: `ecs:DescribeInstances` `acs:ecs:$regionid:$accountid:instance/*` [链接](https://help.aliyun.com/document_detail/25497.html?spm=a2c4g.25506.0.0)
