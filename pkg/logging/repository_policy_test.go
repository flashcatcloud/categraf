...
func TestCoreRuntimeDoesNotUseStandardLogOrDebugBranches(t *testing.T) {
	...
	files := []string{
		...
		"inputs/node_exporter/collector/ethtool_linux.go",
		"inputs/node_exporter/collector/filesystem_common.go",
		"inputs/node_exporter/collector/netclass_rtnl_linux.go",
		"inputs/node_exporter/collector/netdev_common.go",
		...
		"inputs/vsphere/client.go",
		"inputs/vsphere/endpoint.go",
		"inputs/vsphere/tscache.go",
		"inputs/vsphere/vsphere.go",
		"inputs/whois/whois.go",
		"inputs/x509_cert/x509_cert.go",
		"inputs/xskyapi/xskyapi.go",
