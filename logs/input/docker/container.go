...
const configPath = "cloud.flashcat.ad.logs"
...
func (c *Container) getShortImageName(ctx context.Context) (string, error) {
	...
	if err != nil {
		log.Println("Cannot get DockerUtil: %v", err)
...
func (c *Container) isNameMatch(nameFilter string) bool {
	...
	if err != nil {
		log.Println("used invalid name to filter containers: ", nameFilter)
		return false
	}
